    ...
    <div className={twMerge(clsx("p-3 md:p-4"))}>
      ...
      >
        ...
        <div className="px-3 p-4 text-l-color">
          <h3 className="font-semibold text-d-color font-lexend text-lg mb-1">
            {title}
          </h3>
          <p className="text-l-color font-roboto font-normal text-sm">
            {description}
          </p>
          <div className="flex items-center mt-3 gap-2">
            ...
            {/* <span className="text-sm font-bold font-lexend text-d-color ml-2">{`${rating} <span>(${views})</span>`}</span> */}
            {
              <div className="flex items-center gap-1">
                <span className="text-d-color font-lexend font-bold">
                  {rating}
                </span>
